...
export class Backend implements backendInterface {
    ...
    async getCanisterBuildMetadata(): Promise<CanisterBuildMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.getCanisterBuildMetadata();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCanisterBuildMetadata(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCanisterBuildMetadata(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");

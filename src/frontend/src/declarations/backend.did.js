...
export const WalletAddress = IDL.Text;
export const UserProfile = IDL.Record({
  'name' : IDL.Text,
  'walletAddress' : WalletAddress,
});
export const CanisterBuildMetadata = IDL.Record({
  'dfxVersion' : IDL.Text,
  'commitHash' : IDL.Text,
  'buildTime' : IDL.Int,
});
...
export const idlService = IDL.Service({
  ...
  'setCanisterBuildMetadata' : IDL.Func([IDL.Text, IDL.Int, IDL.Text], [], []),
...
export const idlFactory = ({ IDL }) => {
  ...
  const WalletAddress = IDL.Text;
  const UserProfile = IDL.Record({
    'name' : IDL.Text,
    'walletAddress' : WalletAddress,
  });
  const CanisterBuildMetadata = IDL.Record({
    'dfxVersion' : IDL.Text,
    'commitHash' : IDL.Text,
    'buildTime' : IDL.Int,
  });
  ...
  return IDL.Service({
    ...
    'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
    'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
    'getCanisterBuildMetadata' : IDL.Func(
        [],
    ...
    'isStripeConfigured' : IDL.Func([], [IDL.Bool], ['query']),
    'saveCallerUserProfile' : IDL.Func([UserProfile], [], []),
    'setCanisterBuildMetadata' : IDL.Func(
